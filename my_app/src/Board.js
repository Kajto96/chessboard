...
moveBlack(x, y, chessboard) {
  ...
  renderBlack(field, x, y, chessboard) {
    ...
    if (field === null) {
      return <Black onClick={() => dispatch(this.handleOnClick(null, x, y, chessboard))} />
    } else if (field.getCircle() === "circle") {
      return <Black circle={"circle"} selected={this.state.selected === field} onClick={() => dispatch(this.handleOnClick(field, x, y, chessboard))} />;
    } else if (field.getCircle() === "circlew") {
      return <Black circle={"circlew"} selected={useSelector(state => state.selected === field)} onClick={() => dispatch(this.handleOnClick(field, x, y, chessboard))} />;
    } else
      return <Black onClick={() => dispatch(this.handleOnClick(null, x, y, chessboard))} />
  }
